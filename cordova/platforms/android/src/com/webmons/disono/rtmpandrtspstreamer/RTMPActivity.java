...
public class RTMPActivity extends CordovaActivity implements ConnectCheckerRtmp {
    ...
    private void _UIListener() {
        ...
        //ic_preview_orientation.setVisibility(View.GONE);
        ...
        ic_closed.setVisibility(View.GONE);
    ...
    private void _startStreaming() {
        ...
        if (rtmpCameral.prepareAudio() && rtmpCameral.prepareVideo(640, 480,24,2500*1024,false, 0,0)) {
